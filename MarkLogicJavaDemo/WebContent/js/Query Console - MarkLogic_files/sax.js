...
function openTag (parser, selfClosing) {
  ...
  if (!selfClosing) {
    ...
    emitNode(parser, "onopentag_selfclosing", parser.tag)
  }
  parser.attribName = parser.attribValue = ""
  parser.attribList.length = 0
}

function closeTag (parser, selfClosing) {
  if (!parser.tagName) {
  ...
  while (s --> t) {
    ...
    if (selfClosing) {
      emitNode(parser, "onclosetag_selfclosing", parser.tagName)
    }
    else {
